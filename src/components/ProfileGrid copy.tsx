            ...
            <div className="space-y-2.5 flex-1 min-h-0 overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              {spotify.topTracks && spotify.topTracks.length > 0 ? (
                spotify.topTracks.map((track: any) => (
                  <a key={track.id} href={track.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group/track hover:bg-white/5 p-1.5 -m-1.5 rounded-lg transition-all min-w-0">
                    <div className="relative w-10 h-10 rounded-md overflow-hidden bg-zinc-800 shrink-0 shadow-sm flex items-center justify-center">
                      {track.albumArt ? <img src={track.albumArt} alt={track.title} className="w-full h-full object-cover" /> : <Music className={`w-4 h-4 ${mutedColor} shrink-0`} />}
          ...
          <div key={key} style={cardStyle} className={`${colSpanClass} rounded-2xl border border-white/10 overflow-hidden flex flex-col justify-center min-h-[140px] p-2.5 gap-2.5`}>
            {user.socials?.youtube && (
              <a
                ...
                target="_blank"
                className="flex-1 bg-gradient-to-r from-[#FF0000]/20 to-[#FF0000]/5 hover:from-[#FF0000]/40 hover:to-[#FF0000]/20 border border-[#FF0000]/30 rounded-xl p-3 flex items-center justify-between group transition-all min-w-0"
              >
            ...
            {user.socials?.twitch && (
              <a
                ...
                target="_blank"
                className="flex-1 bg-gradient-to-r from-[#9146FF]/20 to-[#9146FF]/5 hover:from-[#9146FF]/40 hover:to-[#9146FF]/20 border border-[#9146FF]/30 rounded-xl p-3 flex items-center justify-between group transition-all min-w-0"
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <div className="w-10 h-10 rounded-xl bg-[#0a0a0c] border border-white/5 flex items-center justify-center shadow-lg group-hover:scale-110 transition shrink-0">
            ...
            {user.steamId && (
              <a
                ...
                target="_blank"
                className="flex-1 bg-gradient-to-r from-[#66c0f4]/20 to-[#66c0f4]/5 hover:from-[#66c0f4]/40 hover:to-[#66c0f4]/20 border border-[#66c0f4]/30 rounded-xl p-3 flex items-center justify-between group transition-all min-w-0"
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <div className="w-10 h-10 rounded-xl bg-[#0a0a0c] border border-white/5 flex items-center justify-center shadow-lg group-hover:scale-110 transition shrink-0">
