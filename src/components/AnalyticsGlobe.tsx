...
interface GlobePulseProps {
  ...
  className?: string
  speed?: number
  totalViews?: number // Accept prop so dashboard doesn't error, even if unused visually
}

// Default global hubs for the radar pings
const defaultMarkers: PulseMarker[] = [
  { id: "pulse-1", location: [37.78, -122.44], delay: 0 },      // SF
  ...
  { id: "pulse-5", location: [40.71, -74.01], delay: 0.2 },     // NYC
  { id: "pulse-6", location: [48.86, 2.35], delay: 0.8 },       // Paris
  { id: "pulse-7", location: [1.35, 103.81], delay: 1.2 },      // Singapore
]
      ...
      {markers.map((m) => (
        ...
        >
          <span style={{
            ...
            border: "2px solid #6366f1", borderRadius: "50%", opacity: 0,
          ...
          <span style={{
            width: 10, height: 10, background: "#6366f1", borderRadius: "50%",
            boxShadow: "0 0 0 3px #050508, 0 0 0 5px #6366f1",
          }} />
        </div>
      ))}
    </div>
