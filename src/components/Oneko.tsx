...
export default function Oneko() {
  useEffect(() => {
    // Prevent it from running if the user prefers reduced motion
    ...
    function create() {
      ...
      // Fetching the original classic Oneko sprite sheet!
    ...
    function idle() {
      idleTime += 1;
      // 1/200 chance every tick to start a random idle animation if not moving
    ...
    function frame() {
      ...
      // Stop moving if close enough to mouse
    ...
    // Clean up when the effect is unmounted or changed
    return () => {
