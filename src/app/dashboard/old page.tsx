...
import { Eye, EyeOff, GripVertical, ExternalLink, Settings, LogOut, Trash2, AlertTriangle, User, Shield, Link2, Palette, Swords, Youtube, Twitch, Maximize2, Minimize2, RotateCcw, Sparkles, MousePointer2, Coins } from "lucide-react";
...
function DashboardContent() {
  ...
  const handleSave = async () => {
    ...
    await updateDoc(userRef, {
      ...
      "theme.cursorTrail": cursorTrail, // New
      "gaming.xbox": xbox,
      "gaming.epic": epic,
      "gaming.valorant": {
        name: riotName,
