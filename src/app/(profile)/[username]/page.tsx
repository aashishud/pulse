...
export default async function ProfilePage({ params }: Props) {
  ...
  // DEBUG LOGGING: Check Vercel Logs to see what ID is being used
  console.log(`[Pulse] Loading profile for: ${username}`);
  console.log(`[Pulse] Linked Steam ID: ${firebaseUser.steamId || "NONE"}`);
